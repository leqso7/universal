...
const riddles = [
  ...
  {
    question: "ფიცრის ათი ნაჭერი გარანდე და დაჭერი, გაუკეთე მურას სახლს იატაკი და...",
    options: ["დაფები", "ფიცრები", "ჭერი"],
    correctAnswer: "ჭერი"
  },
  {
    question: "ზის მოთმენით მდინარესთან. გული აქვს და ო, რა გული ამიტომაც ხშირად ხვდება იმის ანკესს...",
    options: ["მეთევზე", "თევზი", "ორაგული"],
    correctAnswer: "ორაგული"
  },
  {
    question: "თავზე ხე ადგას ისეთი, არწივს სატახტოდ მოუნდა, თურმე ზედ ქორიც ბუდობდა, მისთვის შეარქვეს...",
    options: ["ქორბუდა", "მუხა", "ნაძვი"],
    correctAnswer: "ქორბუდა"
  },
  {
  ...
  {
    question: "ხელის გულს თუ უჩვენებ, ცოტათიღა დაფიქრდი, ცივ ზამთარში ზემოდან, რა გეცემა?...",
  ...
  {
    question: "როდესაც ღრუბელს დავტოვებ ყველაფერი გარბის შინა, აბა თუ კი გამოიცნობ ვინ ვყოფილვარ? ვინ და... ...",
